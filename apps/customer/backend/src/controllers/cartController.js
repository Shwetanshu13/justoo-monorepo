...
export const getCartSummary = async (req, res) => {
    try {
        ...
        // Calculate delivery fee (simplified - in real app, this would be based on delivery zone)
        const deliveryFee = validatedCart.total > 500 ? 0 : 40; // Free delivery above ₹500
